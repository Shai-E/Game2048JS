function GameManager(size, InputManager, Actuator, StorageManager) {
  ...
  this.undoStack      = []; // Initialize an empty undo stack
  this.redoStack      = []; // Initialize an empty redo stack

  this.inputManager.on("move", this.move.bind(this));
  this.inputManager.on("restart", this.restart.bind(this));
  this.inputManager.on("keepPlaying", this.keepPlaying.bind(this));

  this.inputManager.on("undo", this.undo.bind(this)); // Bind undo event
  this.inputManager.on("redo", this.redo.bind(this)); // Bind redo event
...
GameManager.prototype.loadGameState = function (gameState) {
...
GameManager.prototype.pushCurrentState = function () {
  this.undoStack.push(this.serialize());
  this.redoStack = []; // Clear redo stack when a new action is taken
};

GameManager.prototype.clearUndoRedoStacks = function () {
  this.undoStack = [];
  this.redoStack = [];
};